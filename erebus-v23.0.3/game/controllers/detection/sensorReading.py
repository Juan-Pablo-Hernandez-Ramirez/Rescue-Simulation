...
def lee_distancia():
    ...
    d_frontalDerecha = int(sensorFrontalDerecho.getValue() * 1000)
    d_frontalIzquierda = int(sensorFrontalIzquierdo.getValue() * 1000)
    d_delanteraDerecha = int(sensorDelanteroDerecho.getValue() * 1000)
    d_centralDerecha = int(sensorCentralDerecho.getValue() * 1000)
    d_delanteraIzquierda = int(sensorDelanteroIzquierdo.getValue() * 1000)
    d_centralizquierda = int(sensorCentralIzquierdo.getValue() * 1000)
